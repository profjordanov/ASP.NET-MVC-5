...
namespace CarDealer.Services
{
    public class CustomersService : Service
    {
        public IEnumerable<AllCustomerVm> GetAllOrderedCustomers(string order)
        {
            ...
            if (order == "ascending")
            {
                customers =
                    this.Context.Customers.OrderBy(customer => customer.BirthDate)
                        .ThenBy(custom => custom.IsYoungDriver);
            }
            ...
            {
                throw new ArgumentException("The argument you have given for ....");
            }
        ...
        public AboutCustomerVm GetCustomerWithCatData(int id)
        {
        ...
        public void AddCustomer(AddCustomerBm bind)
        {
            ...
            if (DateTime.Now.Year - customer.BirthDate.Year < 21)
            {
        ...
        {
            return Mapper.Map<Customer, EditCustomerVm>(this.Context.Customers.Find(id));
        }
